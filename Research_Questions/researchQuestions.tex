\chapter{Research Questions and Goals}
...
\end{enumerate}
%%%
% The vast majority of the time will be spent on designing the simulator, data processing and visualization tools, followed by their verification and validation. A relatively smaller time would then remain to perform the research and investigate the results, however the time remaining for this would be sufficient to answer all our research questions.
