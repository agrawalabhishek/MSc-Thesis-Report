...
\FloatBarrier
%%%
An example for this is shown in \Cref{fig:LoGSP_1_capture_case_8_2d_comparative_animation_phasingExample}.
%%%
\begin{figure}[htb]
\centering
\captionsetup{justification=centering}
% another option for includegraphics - keepaspectratio
\includegraphics[angle=90, keepaspectratio]{longest_edge_perturbations/3.2Density_1cmSize/phasingExample_8ms_165Azimuth_45SolarPhase_comparative_animation_snippet.pdf}
\caption{Animation snippet for an inertial frame 2D trajectory (XY plane) of capture regolith for capture case number 8 in \Cref{tab:LoGSP_1_capture}. Particle code LoGSP-1.}
