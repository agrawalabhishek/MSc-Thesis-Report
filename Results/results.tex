...
LoGSP-1     &   4.0     &   3.2     &   0.0234      \\ \hline
LoGSP-2     &   0.5     &   3.2     &   0.1875      \\ \hline
LoGSP-3     &   0.1     &   3.2     &   0.9375      \\ \hline
LoGSP-4     &   4.0     &   7.5     &   0.01        \\ \hline
LoGSP-5     &   0.5     &   7.5     &   0.08        \\ \hline
LoGSP-6     &   0.1     &   7.5     &   0.4         \\ \hline
\end{tabular}
\end{table}
\FloatBarrier
%%%
...
We now present a detailed analysis for one of the regolith types, particle LoGSP-1, because Olivine is the most abundant of the regolith types found on Eros and among the different grain sizes for Olivine, LoGSP-1 offers the least area-to-mass ratio. A smaller value for area-to-mass ratio means relatively smaller effect of \gls{SRP} on the regolith which makes it more interesting since we want to know if smaller area-to-mass ratios can also result in capture orbit scenarios.
