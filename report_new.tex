...
\coverimage{cover/Thesis_cover2.pdf}
\makecover
...
\addtocontents{toc}{\protect\setcounter{tocdepth}{4}}
  \input{Modeling/other_gravity_potential_models}
  \input{V&V/verification_validation}
  ...
  This appendix contains figures which are used to support the explanation of certain results, arguments and conclusions in the main part of the Thesis report.
    ...
    \captionsetup{justification=centering}
    \subfloat[]{
        \includegraphics[width=\textwidth, height=0.5\textheight, keepaspectratio=true]{Results/Images/non_conservative_escape_speed/5ms_270Azim_40Decl_2dTraj.pdf}
        \label{fig:40Deg_declination}
    }

    \subfloat[]{
        \includegraphics[width=\textwidth, height=0.5\textheight, keepaspectratio=true]{Results/Images/non_conservative_escape_speed/5ms_270Azim_41Decl_2dTraj.pdf}
        \label{fig:41Deg_declination}
    }
    \caption{Trajectory plots for regolith launched from the longest edge of the asteroid at \SI{5}{\metre\per\second}, at two different launch declinations \protect\subref{fig:40Deg_declination} \SI{40}{\degree} and \protect\subref{fig:41Deg_declination} \SI{41}{\degree} are shown.}
    ...
    \caption{\gls{CGES} variation with launch azimuth for particles launched from an equatorial site on a spherical asteroid of radius \SI{20}{\kilo\metre}.}
    \label{fig:spherical_asteroid_20km_conservative_escape_speed}
    \end{figure}
    \FloatBarrier
    %%%
    %%%
    ...
    \captionsetup{justification=centering}
    \subfloat[]{
        \includegraphics[width=0.5\textwidth, height=0.5\textheight, keepaspectratio=true]{Results/Images/longest_edge_no_perturbations/9ms_crashMap_view1.png}
        \label{fig:crash_3d_9ms_view1}
    }
    \subfloat[]{
        \includegraphics[width=0.5\textwidth, height=0.5\textheight, keepaspectratio=true]{Results/Images/longest_edge_no_perturbations/9ms_crashMap_view2.png}
        \label{fig:crash_3d_9ms_view2}
    }

    \subfloat[]{
        \includegraphics[width=0.5\textwidth, height=0.5\textheight, keepaspectratio=true]{Results/Images/longest_edge_no_perturbations/9ms_crashMap_view3.png}
        \label{fig:crash_3d_9ms_view3}
    }
    \subfloat[]{
        \includegraphics[width=0.5\textwidth, height=0.5\textheight, keepaspectratio=true]{Results/Images/longest_edge_no_perturbations/9ms_crashMap_view4.png}
    ...
    \captionsetup{justification=centering}
    \subfloat[]{
        \includegraphics[width=0.5\textwidth, height=0.5\textheight, keepaspectratio=true]{Results/Images/longest_edge_no_perturbations/13ms_crashMap_view1.png}
        \label{fig:crash_3d_13ms_view1}
    }
    \subfloat[]{
        \includegraphics[width=0.5\textwidth, height=0.5\textheight, keepaspectratio=true]{Results/Images/longest_edge_no_perturbations/13ms_crashMap_view2.png}
        \label{fig:crash_3d_13ms_view2}
    }

    \subfloat[]{
        \includegraphics[width=0.5\textwidth, height=0.5\textheight, keepaspectratio=true]{Results/Images/longest_edge_no_perturbations/13ms_crashMap_view3.png}
        \label{fig:crash_3d_13ms_view3}
    }
    \subfloat[]{
        \includegraphics[width=0.5\textwidth, height=0.5\textheight, keepaspectratio=true]{Results/Images/longest_edge_no_perturbations/13ms_crashMap_view4.png}
    ...
    \centering
    \captionsetup{justification=centering}
    \includegraphics[width=\linewidth, height=0.4\textheight, keepaspectratio=true]{Results/Images/longest_edge_perturbations/3.2Density_1cmSize/10ms_45Azimuth_315SolarPhase/noSRP_eccentricity_energy.pdf}
    ...
    \centering
    \captionsetup{justification=centering}
    \includegraphics[width=\linewidth, height=0.4\textheight, keepaspectratio=true]{Results/Images/longest_edge_perturbations/3.2Density_1cmSize/10ms_45Azimuth_315SolarPhase/noSRP_acceleration_magnitudes.pdf}
    ...
    \label{fig:longestEdge_crashmap_3.2_density_1cm_5cm_Radius}
    \end{figure}
    \FloatBarrier
    %%%
    %%%
    ...
    \label{fig:longestEdge_crashmap_7.5_density_1cm_5cmRadius}
    \end{figure}
    \FloatBarrier
    %%%
    %%%
    ...
    \label{fig:longestEdge_crashmap_3.2_7.5_density_5cmRadius}
    \end{figure}
    \FloatBarrier
    %%%
    %%%
    ...
    % \centering
    % \captionsetup{justification=centering}
    % \includegraphics[width=\textwidth, height=0.4\textheight, keepaspectratio=true]{Results/Images/longest_edge_perturbations/multiple_regolith_types/2d_traj_6ms_20Azim_45SolarPhase_zoomed_edit.pdf}
